...
- [Opdrachtbeschrijving](#opdrachtbeschrijving)
  ...
  - [Inleiding](#inleiding)
  - [Opdracht 1: opzet](#opdracht-1-opzet)
    - [1.1 Projectopzet](#11-projectopzet)
    - [1.2 Stylingopzet](#12-stylingopzet)
  - [Opdracht 2: header en introductie](#opdracht-2-header-en-introductie)
    - [Aandachtspunt 1](#aandachtspunt-1)
  - [Opdracht 3: projecten](#opdracht-3-projecten)
    - [Aandachtspunt 2](#aandachtspunt-2)
  - [Opdracht 4: services](#opdracht-4-services)
    - [Aandachtspunt 3](#aandachtspunt-3)
  - [Opdracht 5: contactformulier en footer](#opdracht-5-contactformulier-en-footer)
    - [Aandachtspunt 4](#aandachtspunt-4)
  - [Bonusopdracht](#bonusopdracht)
  - [Schermontwerpen](#schermontwerpen)
    - [Basisontwerp](#basisontwerp)
    - [Bonusontwerp](#bonusontwerp)
  - [Bijlage](#bijlage)
    - [Voorbeeld CSS structuur](#voorbeeld-css-structuur)
    - [Dummy tekst](#dummy-tekst)
      - [Your website is an investment in the success of your business.](#your-website-is-an-investment-in-the-success-of-your-business)
      - [Hello](#hello)
      - [Work](#work)
...
_Let op:_ bovenstaand voorbeeld bevat bonus-opdracht elementen!
...
- [ ] Declareer alvast een CSS-reset in jouw CSS-bestand. _Pssst_: vergeet jouw stylesheet niet te koppelen aan
      jouw `index.html`.
...
- [ ] De ontwerper heeft de gebruikte kleuren voor ons
      ...
      hebt. _Tip_: je kunt ook gebruik maken van
...
1. Zet eerst, _zonder_ styling, alle benodigde HTML-elementen voor deze twee blokken in jouw `index.html`. Omdat je hier
...
2. **Navigatiebalk**: zorg ervoor dat jouw menu-items netjes, naast elkaar, aan de rechterkant komen te staan. Maak het
   ...
   doet. _Pssst_: je hebt dit al gemaakt in de eerdere Flexbox opdracht!
3. **Content positionering**:
   1. **Header**: zorg ervoor dat de content van de header in het midden komt te staan. _Tip_: gebruik padding om de
...
- In de header is een _gradient_ gebruikt met de aangeleverde kleuren blauw en paars. _Tip:_ gebruik
  een [gradient-generator](https://cssgradient.io/) voor een mooi vloeiend verloop!

- De links in de navigatiebalk linken naar hun bijbehorende _gebied_ op de homepagina: dit noem je een **jumplink**. Dus
...
Vervolgens geven we de afbeelding altijd een `width: 100%`, zodat ze altijd 100% van de _beschikbare ruimte_ zullen
...
- Het is je waarschijnlijk opgevallen dat de volgorde van de tekst en de afbeelding zijn omgedraaid bij het 2e project.
  ...
  de `flex-direction` property. Je kunt de richting namelijk _reversen_! Daar lees
...
- ... en als je alvast wil inspelen op het feit dat er in de toekomst waarschijnlijk meer projecten bij komen, waarbij
  ...
  dus alle _even_ getallen. Super handig wanneer er nog meer projecten bij komen!
...
- _Tip_: je kunt placeholders stylen doormiddel van de `::placeholder`-selector!
...
3. Voeg de zwevende woorden "hello", "work" en "services" toe achter de content. Dit kun je doen door de tekst
   letterlijk in de HTML te zetten, maar het is beter om dit te doen door een **pseudo-element** te gebruiken _(EdHub
   Hfst. 9.2)_.
...
6. Zorg ervoor dat er een transitie ontstaat wanneer de gebruiker over de project-links hovert _(EdHub Hfst. 9.5)_:
